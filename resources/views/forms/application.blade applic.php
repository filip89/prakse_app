        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/apply/' . $applic->student->id ) }}">
                        {{ csrf_field() }}
						...
						<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="name" value="{{ $applic->student->name }}"/>
						...
						<div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="txt" class="form-control" name="last_name" value="{{ $applic->student->last_name }}"/>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ $applic->email }}"/>
						...
						<div class="form-group{{ $errors->has('residence_town') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="residence_town" value="{{ $applic->residence_town }}"/>
						...
						<div class="form-group{{ $errors->has('residence_county') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="residence_county" value="{{ $applic->residence_county }}"/>
						...
						<div class="form-group{{ $errors->has('average_bacc_grade') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="number" max="5" step="0.01" min="2" class="form-control" name="average_bacc_grade" value="{{ $applic->average_bacc_grade }}" />
						...
						<div class="form-group{{ $errors->has('average_master_grade') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="number" max="5" step="0.01" class="form-control" name="average_master_grade" value="{{ $applic->average_master_grade }}"/>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6">
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="1">Option 1</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="2">Option 2</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="3">Option 3</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="4">Option 4</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="5">Option 5</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="6">Option 6</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="7">Option 7</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="8">Option 8</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="9">Option 9</label>
								</div>
								<div class="checkbox">
									<label><input type="checkbox" name="activities[]" value="10">Option 10</label>
								</div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
								...
								<a href="myapplic/{{ $applic->student->id }}">
